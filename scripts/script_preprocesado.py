...
def preprocesar(datos_clientes):
    ...
    datos_clientes = datos_clientes.query("person_emp_length < @LIMITE_EXP_LABORAL and person_age < @LIMITE_EDAD and person_emp_length <= (person_age-16)") #defino universo de datos razonable para el modelo
