...
from app.processing.test.factory_clientes import REGLAS
from app.processing.test.estrategias_clientes import df_valido, df_invalido, df_con_indice, df_mixto, df_lista_mixta
#defino el escenario
@pytest.fixture
def validador():
