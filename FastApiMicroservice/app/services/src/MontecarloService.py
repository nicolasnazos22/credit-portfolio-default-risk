import numpy as np
from app.domain.schemas import PortfolioRiskSimulationResponse
class MontecarloService:
    ...
    def simular_riesgo_portfolio(self, probabilidades: list[float], cantidad_escenarios: int) -> PortfolioRiskSimulationResponse:
        ...
        generacion_aleatoria = self.rng.random((cantidad_escenarios, cantidad_prestamos))
        ...
        peores_iteraciones = defaults_por_iteracion[defaults_por_iteracion >= var_95]
